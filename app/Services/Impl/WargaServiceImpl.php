...
class WargaServiceImpl implements WargaService {
    ...
    public function updateWarga(WargaEntity $wargaEntity): AppEntity{
        ...
        $warga->update([
            ...
            'kk' => $wargaEntity->getKk() ?? $warga->kk,
            'rtrw' => $wargaEntity->getRtrw() ?? $warga->rtrw,
            'desa' => $wargaEntity->getDesa() ?? $warga->desa,
            'kecamatan' => $wargaEntity->getKecamatan() ?? $warga->kecamatan,
    ...
    public function createWarga(WargaEntity $wargaEntity): AppEntity{
        $warga = DataWarga::create([
            ...
            'kk' => $wargaEntity->getKk(),
            'rtrw' => $wargaEntity->getRtrw(),
            'desa' => $wargaEntity->getDesa(),
            'kecamatan' => $wargaEntity->getKecamatan(),
